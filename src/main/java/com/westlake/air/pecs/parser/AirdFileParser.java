...
public class AirdFileParser extends BaseParser {
    ...
    public MzIntensityPairs parseValueFromText(RandomAccessFile raf, long start, long end, String compressionType, String precision){
    ...
    public MzIntensityPairs parseValueFromBin(RandomAccessFile raf, long start, long end, String compressionType, String precision){

...
public class SuccessMsg {
    ...
    public static String CREATE_LIBRARY_SUCCESS = "创建标准库成功! Create Library Success!";
    public static String DELETE_LIBRARY_SUCCESS = "删除标准库成功! Delete Library Success!";
    public static String CREATE_EXPERIMENT_AND_INDEX_SUCCESS = "创建实验索引成功! Create Experiment Index Success!";
